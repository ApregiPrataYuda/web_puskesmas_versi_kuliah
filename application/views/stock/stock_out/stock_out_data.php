     ...
     <?php $this->load->view('flash_messages');?>
          <div class="box">
            <div class="box-header with-border">
              ...
              <a href="<?= site_url('Stock/xportExcel')?>" class="btn btn-success btn-sm"><i class="fa  fa-file-excel-o">  Export excel</i></a>
           
                 <a href="<?= site_url('Stock/out/add')?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"> add stock out</i></a>
              </div>
            </div>
                                  ...
                                  <td><?=$data->kode_obat?></td>
                                    <td class="text-center"><?=$data->nama_obat?></td>
                                       ...
                                       <td>
                                         ...
                                         <a href="<?=site_url('Stock/out/delete/'.$data->stock_id.'/'.$data->obat_id)?>" onclick="return confirm('yakin data akan di hapus?')" class="btn btn-warning btn-xs"><i class="fa fa-trash">delete</i> </a>
                                        </td>
                                        </tr>
                     <?php } ?>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body table-responsive">
                 <table class="table table-bordered no-margin">
                   ...
                   <tr>
                           <th>jumlah obat yang rusak / dll</th>
